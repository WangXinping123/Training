...
public class qianggounum extends BaseTest{
	@DataProvider(name="datal")
	public Object[][] getExcelDada() throws Exception{
		return new TxtDataProvider().getTxtUser("D://ceshi//shixun//data//yingxiao//changyongcuxiao1//qianggounum//qianggounum.txt");
	}
	//正确

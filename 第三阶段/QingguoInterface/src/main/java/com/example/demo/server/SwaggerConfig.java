 ...
 * }
 * 
 * public ApiInfo apiInfo() { return new ApiInfoBuilder().title("我们的接口文档").
 * contact(new Contact("lihuanzhen","","lhz@126.com"))
 * .description("这是SwaggerUI生成的接口文档").version("1.0").build(); }
 * 
 * }
 */